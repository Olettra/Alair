...
export const FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "No. alik is for real-life connection of every kind, friendship and community as much as romance, and it never forces what a connection becomes.",
  },
  {
    q: "How is alik different from dating apps?",
    a: "You never swipe through profiles. You simply talk to your AI; it does the finding for you, its AI talks to other people's AI, and it introduces you in real life. Dating apps make you search for a person. alik helps you walk into the right room.",
  },
  {
  ...
  {
    q: "Who can join alik?",
    a: "alik is invite-only and built for adults 25 and up. You can request an invite to be considered for an early group.",
  },
  {
    q: "Can you earn money on alik?",
    a: "Optionally, yes. While your circle grows, alik can bring you paid work such as short studies and teaching AI what only a real person knows. It is a bonus, never the point. The promise is connection.",
  },
];
