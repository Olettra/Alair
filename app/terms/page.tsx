      ...
      <main className="mx-auto max-w-3xl px-6 py-16 text-center">
        ...
        <section className="space-y-6 text-[15px] leading-relaxed text-white/90">
          ...
          <p>
            ...
            terms and conditions on this page. &ldquo;alik&rdquo;,
          ...
          <p>
            ...
            (&ldquo;User Content&rdquo;). By submitting it, you grant alik a
          ...
          <p>
            alik introduces people for in-person experiences like coffee and
          ...
          <p>
            You agree to defend, indemnify, and hold harmless alik and its
          ...
          <p className="uppercase text-white/80 text-sm">
            To the maximum extent permitted by law, alik and its affiliates
          ...
          <p>
            These Terms are the entire agreement between you and alik about
