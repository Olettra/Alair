...
function StatementBlock() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 text-center">
      ...
      <motion.p
        {...(reduce ? {} : reveal(0.14))}
        className="max-w-md text-balance font-serif font-semibold text-forest/85 text-[clamp(0.95rem,4.5vw,1.35rem)] leading-snug sm:max-w-none sm:whitespace-nowrap sm:text-[clamp(0.8rem,2.3vw,1.35rem)]"
      >
        Because you don&rsquo;t need to match and try with a hundred strangers.
      </motion.p>
      ...
      >
        You just need someone who wants to do{" "}
        <span className="italic text-muted underline decoration-terracotta decoration-2 underline-offset-4">
          the same things you actually love doing
        </span>
        .
      </motion.p>
